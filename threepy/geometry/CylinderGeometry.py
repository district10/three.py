...
class CylinderGeometry(SurfaceGeometry):
    ...
    def __init__(self,
                 ...
                 circleBottom=True):
        super().__init__(
            0, 2 * pi, radialSegments, 0, 1, heightSegments, lambda a, b:
            [(b * radiusTop + (1 - b) * radiusBottom) * cos(-a), (b - 0.5) *
             height, (b * radiusTop + (1 - b) * radiusBottom) * sin(-a)])
        ...
        if circleTop:
            ...
            for i in range(radialSegments):
                posA = [
                    radiusTop * cos(i * angle), height / 2,
                    radiusTop * sin(i * angle)
                ]
                posB = [
                    radiusTop * cos((i + 1) * angle), height / 2,
                ...
                uvB = [
                    cos((i + 1) * angle) * 0.5 + 0.5,
                    sin((i + 1) * angle) * 0.5 + 0.5
                ]
        ...
        if circleBottom:
            ...
            for i in range(radialSegments):
                posA = [
                    radiusBottom * cos(i * angle), -height / 2,
                    radiusBottom * sin(i * angle)
                ]
                posB = [
                    radiusBottom * cos((i + 1) * angle), -height / 2,
