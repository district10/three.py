import numpy as np
from threepy.mathutils.MatrixFactory import *
...
class Matrix(object):
    ...
    def getRotationMatrix(self):
        return np.array(
            [self.matrix[0][0:3], self.matrix[1][0:3], self.matrix[2][0:3]])

    # rotate matrix to look at target=[x,y,z]
    def lookAt(self, x, y, z):
        self.matrix = MatrixFactory.makeLookAt(self.getPosition(), [x, y, z],
                                               [0, 1, 0])
